...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductoID" DataSourceID="SqlDataSource1">
        <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="ProductoID" DataNavigateUrlFormatString="GestionarProductos.aspx?ProductoID={0}" HeaderText="Eliminar" Text="Desactivar/Activar" />
        </Columns>
    </asp:GridView>
